...
$qq=array_key_last($z);
$i++;
if($_COOKIE['ina']=='t'){$xx="<td style='text-align:right'>".number_format(filesize($name))."</td></tr>";}else{$xx="</tr>";}
...
'have cp li','young fun','dick swing','dick up your ass','rucify them','any kids?','omgporn','c. P.','1096047','rape/forced vid','rape vid','gay gay','kids pant','ids shorts down','pant pull','have any cp',
'illegal porn','cp or rape','buy cp','purchase cp','get cp','I find cp','i find cp','fuck their children','fuck their kids','suck my dick','suck cock'];
foreach($x as $y){
